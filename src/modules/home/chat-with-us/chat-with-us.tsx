...
export default function ChatWithUs() {
  return (
    <Section className="bg-gradient-secondary-bg rounded-2xl flex flex-col md:flex-row justify-between items-center h-[300px] md:h-[260px] lg:h-[285px] md:px-[20px] lg:px-[88px]">
      <h4 className="bg-gradient-dark-bg bg-clip-text text-transparent font-bold text-lg md:text-2xl lg:text-4xl max-w-[531px] md:leading-[55px] max-md:mt-8 max-md:text-center">
